...
from failure_instance_feature_extractor.TCN import TCNFeatureModule
...
class FIFeatureExtractor(th.nn.Module):
    ...
    def __init__(
        ...
        for node_type, input_size in zip(failure_classes, input_tensor_size_list):
            ...
            elif feature_projector_type == 'TCN':
                self.features_projection_module_list.append(TCNFeatureModule(input_size, feature_size))
