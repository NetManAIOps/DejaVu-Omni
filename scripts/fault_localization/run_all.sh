...
do
    ...
    # Eadro
    python exp/DejaVu/run_Eadro.py --data_dir /DejaVu-Omni/data/${dataset}/ --output_base_path /DejaVu-Omni/output/fault_localization/${dataset}/eadro/ --dataset_split_ratio 0.4 0.2 0.4
    # JSS'20
    python exp/DejaVu/run_JSS20.py --data_dir /DejaVu-Omni/data/${dataset}/ --output_base_path /DejaVu-Omni/output/fault_localization/${dataset}/JSS20/ --dataset_split_ratio 0.4 0.2 0.4
    # iSQUAD
    ...
    # RandomWalk@FI
    python exp/DejaVu/run_random_walk_failure_instance.py --data_dir /DejaVu-Omni/data/${dataset}/ --window_size 60 10 --anomaly_score_aggregation_method=min --corr_aggregation_method=max --output_base_path /DejaVu-Omni/output/fault_localization/${dataset}/RandomWalkFI/ --dataset_split_ratio 0.4 0.2 0.4 
done
